...
data.obj0 <- baxter.stool.data.obj.wk
dist.obj0 <- baxter.stool.dist.obj.wk
...
dir.create(paste0('~/Dropbox/Workspace/MayoClinic/2016_11_16_Leigh_Metaanalysis/Result/16S/', study, '/PooledBMI'))
...
#### Alpha-diversity comparison
dir.create(paste0('~/Dropbox/Workspace/MayoClinic/2016_11_16_Leigh_Metaanalysis/Result/16S/', study, '/PooledBMI/Alpha_Diversity'))
setwd(paste0('~/Dropbox/Workspace/MayoClinic/2016_11_16_Leigh_Metaanalysis/Result/16S/', study, '/PooledBMI/Alpha_Diversity'))
...
#### Beta-diversity comparison
dir.create(paste0('~/Dropbox/Workspace/MayoClinic/2016_11_16_Leigh_Metaanalysis/Result/16S/', study, '/PooledBMI/Beta_Diversity'))
setwd(paste0('~/Dropbox/Workspace/MayoClinic/2016_11_16_Leigh_Metaanalysis/Result/16S/', study, '/PooledBMI/Beta_Diversity'))
...
save(permanova.obj, file=paste0(study, '.beta.test.RData'))
#### Taxa-diversity comparison
dir.create(paste0('~/Dropbox/Workspace/MayoClinic/2016_11_16_Leigh_Metaanalysis/Result/16S/', study, '/PooledBMI/Taxa_Diversity'))
setwd(paste0('~/Dropbox/Workspace/MayoClinic/2016_11_16_Leigh_Metaanalysis/Result/16S/', study, '/PooledBMI/Taxa_Diversity'))
...
generate_alpha_boxplot(data.obj, phylo.obj, rarefy=FALSE, grp.name='Status', 
		measures=c('Observed', 'Shannon'), gg.cmd='scale_colour_manual(values=cbPalette[c(3,  7)])', ann=paste0(study, '.Status'))
