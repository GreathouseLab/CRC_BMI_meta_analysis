...
data.obj0 <- Zeller.data.obj.wk
dist.obj0 <- Zeller.dist.obj.wk
...
alpha.obj.cat <- perform_alpha_test(data.obj, phylo.obj, rarefy=TRUE, measures=c('Observed',  'Shannon'),  model='lm', 
		grp.name='BMI.cat', adj.name=c('Gender', 'Age', 'Country'), ann=paste0(study, '.BMI.cat'))

alpha.obj <- perform_alpha_test(data.obj, phylo.obj, rarefy=TRUE, measures=c('Observed',  'Shannon'),  model='lm', 
		grp.name='BMI', adj.name=c('Gender', 'Age', 'Country'), ann=paste0(study, '.BMI'))
...
diff.obj <- perform_differential_analysis_para(data.obj,  grp.name='BMI', adj.name=c('Gender', 'Age', 'Country'),  RE=FALSE, method='NB', 
...
alpha.obj.cat <- perform_alpha_test(data.obj, phylo.obj, rarefy=TRUE, measures=c('Observed',  'Shannon'),  model='lm', 
		grp.name='BMI.cat', adj.name=c('Gender', 'Age', 'Country', 'Status'), ann=paste0(study, '.BMI.cat'))

alpha.obj <- perform_alpha_test(data.obj, phylo.obj, rarefy=TRUE, measures=c('Observed',  'Shannon'),  model='lm', 
		grp.name='BMI', adj.name=c('Gender', 'Age', 'Country', 'Status'), ann=paste0(study, '.BMI'))
...
diff.obj <- perform_differential_analysis_para(data.obj,  grp.name='BMI', adj.name=c('Gender', 'Age', 'Country', 'Status'),  RE=FALSE, method='NB', 
		taxa.levels=c('Phylum', 'Class', 'Order', 'Family', 'Genus', 'Species'), winsor=TRUE, winsor.qt=0.97, norm='TSS', norm.level='Species', intersect.no=4,
		prev=0.1, minp=0.002, medianp=NULL, mt.method='raw', cutoff=0.05, ann=paste0(study, '.BMI.TSSNB'))
...
alpha.obj <- perform_alpha_test(data.obj, phylo.obj, rarefy=TRUE, measures=c('Observed',  'Shannon'),  model='lm', 
		grp.name='Status', adj.name=c('Gender', 'Age', 'Country', 'BMI'), ann=paste0(study, '.DS'))
...
diff.obj <- perform_differential_analysis_para(data.obj,  grp.name='Status', adj.name=c('Gender', 'Age', 'Country', 'BMI'),  RE=FALSE, method='NB', 
		taxa.levels=c('Phylum', 'Class', 'Order', 'Family', 'Genus', 'Species'), winsor=TRUE, winsor.qt=0.97, norm='TSS', norm.level='Species', intersect.no=4,
